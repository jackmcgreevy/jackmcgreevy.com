...
class __TwigTemplate_17c4cb3fbac23f2cf1204ce80fd38df91fc8c22936398a7ca2566f3ac9910a95 extends Craft\BaseTemplate
{
...
\t";
        // line 6
        $context["fromEmail"] = ((array_key_exists("getHelp", $context)) ? ($this->getAttribute((isset($context["getHelp"]) ? $context["getHelp"] : $this->getContext($context, "getHelp")), "fromEmail", array())) : ($this->getAttribute((isset($context["currentUser"]) ? $context["currentUser"] : $this->getContext($context, "currentUser")), "email", array())));
        // line 7
        echo "
\t";
        // line 8
...
(isset($context["fromEmail"]) ? $context["fromEmail"] : $this->getContext($context, "fromEmail")), "errors" => ((        // line 17
array_key_exists("getHelp", $context)) ? ($this->getAttribute((isset($context["getHelp"]) ? $context["getHelp"] : $this->getContext($context, "getHelp")), "getErrors", array(0 => "fromEmail"), "method")) : (""))));
        // line 18
        echo "
...
(isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "config", array()), "backupDbOnUpdate", array())));
        // line 43
        echo "
