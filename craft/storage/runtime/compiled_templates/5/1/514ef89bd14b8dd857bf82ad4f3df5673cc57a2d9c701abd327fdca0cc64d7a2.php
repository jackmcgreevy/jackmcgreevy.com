...
/* entries */
class __TwigTemplate_514ef89bd14b8dd857bf82ad4f3df5673cc57a2d9c701abd327fdca0cc64d7a2 extends Craft\BaseTemplate
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 6
        $context["sections"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "sections", array()), "getEditableSections", array(), "method");
        // line 7
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["section"]) {
            // line 10
            if ((($this->getAttribute($context["section"], "type", array()) != "single") && $this->getAttribute((isset($context["currentUser"]) ? $context["currentUser"] : $this->getContext($context, "currentUser")), "can", array(0 => ("createEntries:" . $this->getAttribute($context["section"], "id", array()))), "method"))) {
                // line 11
                $context["newEntrySections"] = twig_array_merge((isset($context["newEntrySections"]) ? $context["newEntrySections"] : $this->getContext($context, "newEntrySections")), array(0 => $context["section"]));
            }
        }
        ...
        if (array_key_exists("sectionHandle", $context)) {
            // line 41
            $_js = (("window.defaultSectionHandle = \"" . (isset($context["sectionHandle"]) ? $context["sectionHandle"] : $this->getContext($context, "sectionHandle"))) . "\";");
...
\t\t\t";
                ...
                echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl((("entries/" . $this->getAttribute($this->getAttribute((isset($context["newEntrySections"]) ? $context["newEntrySections"] : $this->getContext($context, "newEntrySections")), 0, array(), "array"), "handle", array())) . "/new")), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, \Craft\Craft::t("New Entry"), "html", null, true);
                echo "</a>
\t\t\t";
