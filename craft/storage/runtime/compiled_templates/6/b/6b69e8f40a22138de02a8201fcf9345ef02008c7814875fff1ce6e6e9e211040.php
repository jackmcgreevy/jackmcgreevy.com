...
/* _includes/forms */
class __TwigTemplate_6b69e8f40a22138de02a8201fcf9345ef02008c7814875fff1ce6e6e9e211040 extends Craft\BaseTemplate
{
...
";
    ...
    public function gethidden($__config__ = null)
    {
        ...
        try {
            // line 10
            $this->loadTemplate("_includes/forms/hidden", "_includes/forms", 10)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function gettext($__config__ = null)
    {
        ...
        try {
            // line 15
            echo "\t";
            $this->loadTemplate("_includes/forms/text", "_includes/forms", 15)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getpassword($__config__ = null)
    {
        ...
        try {
            // line 20
            echo "\t";
            $this->loadTemplate("_includes/forms/text", "_includes/forms", 20)->display(twig_array_merge((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), array("type" => "password")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getdate($__config__ = null)
    {
        ...
        try {
            // line 25
            echo "\t";
            $this->loadTemplate("_includes/forms/date", "_includes/forms", 25)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function gettime($__config__ = null)
    {
        ...
        try {
            // line 30
            echo "\t";
            $this->loadTemplate("_includes/forms/time", "_includes/forms", 30)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getcolor($__config__ = null)
    {
        ...
        try {
            // line 35
            echo "\t";
            $this->loadTemplate("_includes/forms/color", "_includes/forms", 35)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function gettextarea($__config__ = null)
    {
        ...
        try {
            // line 40
            echo "\t";
            $this->loadTemplate("_includes/forms/textarea", "_includes/forms", 40)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getselect($__config__ = null)
    {
        ...
        try {
            // line 45
            echo "\t";
            $this->loadTemplate("_includes/forms/select", "_includes/forms", 45)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getmultiselect($__config__ = null)
    {
        ...
        try {
            // line 50
            echo "\t";
            $this->loadTemplate("_includes/forms/multiselect", "_includes/forms", 50)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getcheckbox($__config__ = null)
    {
        ...
        try {
            // line 55
            echo "\t";
            $this->loadTemplate("_includes/forms/checkbox", "_includes/forms", 55)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getcheckboxGroup($__config__ = null)
    {
        ...
        try {
            // line 60
            echo "\t";
            $this->loadTemplate("_includes/forms/checkboxGroup", "_includes/forms", 60)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getcheckboxSelect($__config__ = null)
    {
        ...
        try {
            // line 65
            echo "\t";
            $this->loadTemplate("_includes/forms/checkboxSelect", "_includes/forms", 65)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getradio($__config__ = null)
    {
        ...
        try {
            // line 70
            echo "\t";
            $this->loadTemplate("_includes/forms/radio", "_includes/forms", 70)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getradioGroup($__config__ = null)
    {
        ...
        try {
            // line 75
            echo "\t";
            $this->loadTemplate("_includes/forms/radioGroup", "_includes/forms", 75)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getfile($__config__ = null)
    {
        ...
        try {
            // line 80
            echo "\t";
            $this->loadTemplate("_includes/forms/file", "_includes/forms", 80)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getlightswitch($__config__ = null)
    {
        ...
        try {
            // line 85
            echo "\t";
            $this->loadTemplate("_includes/forms/lightswitch", "_includes/forms", 85)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function geteditableTable($__config__ = null)
    {
        ...
        try {
            // line 90
            echo "\t";
            $this->loadTemplate("_includes/forms/editableTable", "_includes/forms", 90)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getelementSelect($__config__ = null)
    {
        ...
        try {
            // line 95
            echo "\t";
            $this->loadTemplate("_includes/forms/elementSelect", "_includes/forms", 95)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
        } catch (Exception $e) {
            ob_end_clean();
    ...
    public function getfield($__config__ = null, $__input__ = null)
    {
        ...
        try {
            // line 103
            echo "\t";
            $this->loadTemplate("_includes/forms/field", "_includes/forms", 103)->display(twig_array_merge((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), array("input" => (isset($context["input"]) ? $context["input"] : $this->getContext($context, "input")))));
        } catch (Exception $e) {
            ob_end_clean();
...
";
    ...
    public function getcheckboxField($__config__ = null)
    {
        ...
        try {
            // line 153
            echo "\t";
            $context["instructions"] = (($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "instructions", array(), "any", true, true)) ? ($this->getAttribute((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), "instructions", array())) : (""));
            // line 154
            echo "<div class=\"field checkboxfield";
            if (($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "first", array(), "any", true, true) && $this->getAttribute((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), "first", array()))) {
                echo " first";
            }
            ...
            echo "\"";
            if (($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "id", array(), "any", true, true) && $this->getAttribute((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), "id", array()))) {
                echo " id=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), "id", array()), "html", null, true);
                echo "-field\"";
            }
            echo ">
\t\t";
...
";
    ...
    public function geteditableTableField($__config__ = null)
    {
        ...
        try {
            ...
            echo "\t";
            ob_start();
            $this->loadTemplate("_includes/forms/editableTable", "_includes/forms", 184)->display((isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")));
...
";
    ...
    public function getelementSelectField($__config__ = null)
    {
        ...
        try {
            // line 190
            echo "\t";
            echo $this->getAttribute($this, "field", array(0 => (isset($context["config"]) ? $context["config"] : $this->getContext($context, "config")), 1 => $this->getAttribute($this, "elementSelect", array(0 => (isset($context["config"]) ? $context["config"] : $this->getContext($context, "config"))), "method")), "method");
            echo "
";
        } catch (Exception $e) {
            ob_end_clean();
    ...
    // line 197
    public function getoptionShortcutLabel($__key__ = null, $__shift__ = null, $__alt__ = null)
    {
        $context = $this->env->mergeGlobals(array(
            "key" => $__key__,
            "shift" => $__shift__,
        ...
        try {
            ...
            // line 199
            echo "\t\t";
            switch ($this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "request", array()), "getClientOs", array(), "method")) {
                case "Mac":
                {
                    // line 201
                    echo "\t\t\t\t<span class=\"shortcut\">";
                    echo ((((((isset($context["alt"]) ? $context["alt"] : $this->getContext($context, "alt"))) ? ("⌥") : ("")) . (((isset($context["shift"]) ? $context["shift"] : $this->getContext($context, "shift"))) ? ("⇧") : (""))) . "⌘") . (isset($context["key"]) ? $context["key"] : $this->getContext($context, "key")));
                    echo "</span>
\t\t\t";
                    break;
                }
                default:
                {
                    // line 203
                    echo "\t\t\t\t<span class=\"shortcut\">";
                    echo twig_escape_filter($this->env, ((("Ctrl+" . (((isset($context["alt"]) ? $context["alt"] : $this->getContext($context, "alt"))) ? ("Alt+") : (""))) . (((isset($context["shift"]) ? $context["shift"] : $this->getContext($context, "shift"))) ? ("Shift+") : (""))) . (isset($context["key"]) ? $context["key"] : $this->getContext($context, "key"))), "html", null, true);
                    echo "</span>
\t\t";
                }
            }
