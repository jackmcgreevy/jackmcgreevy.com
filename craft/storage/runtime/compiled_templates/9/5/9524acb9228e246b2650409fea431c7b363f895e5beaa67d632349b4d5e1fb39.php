...
/* dashboard */
class __TwigTemplate_9524acb9228e246b2650409fea431c7b363f895e5beaa67d632349b4d5e1fb39 extends Craft\BaseTemplate
{
...
\t\t";
        // line 13
        if (($this->getAttribute((isset($context["currentUser"]) ? $context["currentUser"] : $this->getContext($context, "currentUser")), "admin", array()) && $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "deprecator", array()), "getTotalLogs", array(), "method"))) {
            // line 14
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "dashboard", array()), "getUserWidgets", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["widget"]) {
            // line 22
            echo "\t\t\t";
            $context["widgetType"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "dashboard", array()), "populateWidgetType", array(0 => $context["widget"]), "method");
            // line 23
            echo "\t\t\t";
...
\t\t\t\t\t\t<div id=\"widget";
                    ...
                    echo twig_escape_filter($this->env, twig_lower_filter($this->env, $this->getAttribute((isset($context["widgetType"]) ? $context["widgetType"] : $this->getContext($context, "widgetType")), "classHandle", array())), "html", null, true);
                    echo "\" data-id=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["widget"], "id", array()), "html", null, true);
                    echo "\">
...
\t\t\t\t\t\t\t<h2>";
                    // line 29
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["widgetType"]) ? $context["widgetType"] : $this->getContext($context, "widgetType")), "title", array()), "html", null, true);
                    echo "</h2>
\t\t\t\t\t\t\t<div class=\"body\">";
                    // line 30
